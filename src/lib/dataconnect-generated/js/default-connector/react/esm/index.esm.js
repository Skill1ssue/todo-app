import { createTodoRef, deleteTodoRef, completeTodoRef, listTodoRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useCompleteTodo(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
